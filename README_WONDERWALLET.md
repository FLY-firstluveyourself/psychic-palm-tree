...
- 💾 **Encrypted Backups** - Compressed, encrypted backup with optional passphrase
- 📦 **Backup & Restore** - Export/import wallet data securely
- 🔐 **Zero-Knowledge** - Client-side encryption, non-custodial architecture
...
- **pako** - Compression library for backups
...
### Backup System
- Compressed backups using gzip (60-70% size reduction)
- AES-256 encryption with optional backup passphrase
- SHA-256 checksums for integrity verification
- Export as downloadable `.wbk` files
- Conflict resolution on restore (skip/replace/merge)
- Zero-knowledge, client-side only encryption
- See [BACKUP_SYSTEM_DOCS.md](./BACKUP_SYSTEM_DOCS.md) for details
...
│   ├── BackupService.ts       # Backup/restore, compression, integrity
...
│   ├── BackupScreen.jsx       # Backup management
│   ├── RestoreFromBackupScreen.jsx # Restore from backup file
...
- No transaction sending in v1.0 (coming in v0.2)
- Only Ethereum supported (more chains in v0.2)
