...
function App() {
  ...
  if (currentScreen === 'dashboard') {
    return (
      <DashboardScreen
        ...
        onBackup={() => setCurrentScreen('backup')}
      />
    );
  }
  ...
  if (currentScreen === 'restore-backup') {
    return (
      <RestoreFromBackupScreen
        onBack={() => setCurrentScreen('dashboard')}
        onRestoreComplete={(result) => {
          // After successful restore, go to auth screen
          setCurrentScreen('auth');
        }}
      />
    );
  ...
  if (currentScreen === 'settings') {
    return (
      <SettingsScreen
        ...
        onBackup={() => setCurrentScreen('backup')}
        onRestoreBackup={() => setCurrentScreen('restore-backup')}
      />
    );
  }
