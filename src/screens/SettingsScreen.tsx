...
const SettingsScreen: React.FC<SettingsScreenProps> = ({ onBack, onClearData, onBackup, onRestoreBackup }) => {
          ...
          {(onBackup || onRestoreBackup) && (
            <div className="settings-section">
              ...
              {onBackup && (
                <div className="setting-item action-item">
                  <div className="setting-info">
                    ...
                    <p className="setting-description">
                      Export encrypted backup of all your wallet data
                    </p>
                  </div>
                  <button className="action-btn primary" onClick={onBackup}>
                    💾 Backup
                  </button>
                </div>
              )}
              ...
              {onRestoreBackup && (
                <div className="setting-item action-item">
                  <div className="setting-info">
                    ...
                    <p className="setting-description">
                      Import wallet data from an encrypted backup file
                    </p>
                  </div>
                  <button className="action-btn secondary" onClick={onRestoreBackup}>
                    📥 Restore
                  </button>
                </div>
              )}
              ...
              <div className="info-notice">
                ...
                <p>
                  Regular backups protect your wallet data. Store backups securely and never share them.
                </p>
              </div>
            </div>
          )}
